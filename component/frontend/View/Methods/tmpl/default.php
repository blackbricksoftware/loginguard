        ...
        <div class="akeeba-container--75-25">
            ...
            <div class="loginguard-methods-reset-container-removeall-container">
	            <?php if ($this->tfaActive): ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_loginguard&view=methods&task=disable&' . JFactory::getSession()->getToken() . '=1' . ($this->returnURL ? '&returnurl=' . $this->escape(urlencode($this->returnURL)) : '') . '&user_id=' . $this->user->id) ?>"
